...
- **多源覆盖**：突破传统招聘网站，新增央国企&互联网大厂微信公众号招聘信息
- **开源免费**：Apache 2.0 许可证，可自由使用和修改
...
直接双击 `xiaozhao-radar.html` 文件即可在浏览器中使用，无需安装任何依赖。

## 🔧 使用方法

### 基本操作

1. **启动**：双击 `xiaozhao-radar.html` 打开页面
2. **爬取数据**：
...
- 支持从 11+ 招聘网站和微信公众号实时获取数据
- 新增央国企、互联网大厂、银行券商微信公众号数据源
