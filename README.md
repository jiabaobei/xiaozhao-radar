...
> 本周例行数据同步：校招数据从 1404 条 → **1598 条**（净增 +194），行业分布正常。

- **🔄 例行数据更新（2026-09-03）**：腾讯文档智能表格「27届实习提前批信息汇总」每周同步，`jobs.json` 已更新至 1598 条有效招聘信息（综合 552 / 互联网科技 367 / 装备重工 322 / 银行金融 126 / 汽车制造 62 等）
- 版本号升至 **v2.4.2**
...
### v2.4.2
- **例行数据同步（2026-09-03）**：从腾讯文档智能表格拉取最新数据，`jobs.json` 更新至 **1598 条**（较上版 1404 净增 +194）
- 版本号升至 v2.4.2
